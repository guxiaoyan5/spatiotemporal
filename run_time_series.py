...
from exp.exp_time_series import *
...
def main():
    ...
    parser.add_argument('--model_id', type=str, default='NO2_96_96', help='model id')
    parser.add_argument('--model', type=str, default='Informer',
                        help='model name, options: [Informer]')
    # data loader
    parser.add_argument('--data', type=str, default='no2', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./data/', help='root path of the data file')
    parser.add_argument('--dataset', type=str, default='no2', help='data file')
    ...
    parser.add_argument('--factor', type=int, default=3, help='Informer attn factor')
    # optimization
